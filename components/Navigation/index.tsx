...
export const Navigation = ({
  ...
  return (
    <>
      <nav
        className={
          'custom-container pointer-events-none absolute left-1/2  mx-auto flex w-full -translate-x-1/2 items-center justify-between pr-[10px] '
        }
      >
        ...
        <div className="pointer-events-auto mr-[10px] flex items-center  gap-[25px] ">
          <>
            <Popover
              isOpen={langOpen}
              positions={['left', 'top']}
